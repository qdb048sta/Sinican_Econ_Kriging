...
set linesize 255
cap log c
log using "D:\User_Data\Desktop\kan-2\kriging\regression_result\SO2_month_avg_regression_result_without_outlier_two_comparison.log", replace
cd "D:\User_Data\Desktop\kan-2\kriging"
display "---------------------Daily Average------------------------------"
use "D:\User_Data\Desktop\kan-2\kriging\SO2_avg_with_date_combined.dta" ,clear
keep if _merge==3
...
use "D:\User_Data\Desktop\kan-2\kriging\SO2_max_with_date_combined.dta",clear
keep if _merge==3
